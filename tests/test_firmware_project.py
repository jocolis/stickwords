...
class FirmwareProjectTests(unittest.TestCase):
    ...
    def test_stage5c_idle_timeout_powers_off_outside_setup_mode(self):
        ...
        self.assertIn("M5.Axp.PowerOff()", idle_body)
    ...
    def test_stage5d_firmware_parses_and_caches_offline_card_metadata(self):
        ...
        self.assertIn("nvs,      data, nvs,     0x9000,  0x10000", partitions)
        ...
        self.assertIn("storage.getBytesLength(\"cards\")", load_body)
        self.assertIn("sizeof(LegacyDeviceCard) * storedCount", load_body)
        self.assertIn("copyLegacyCard(&syncedCards[i]", load_body)
