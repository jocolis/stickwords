...
class FirmwareProjectTests(unittest.TestCase):
    ...
    def test_stage6_clock_render_does_not_clear_m5gfx_before_lvgl_refresh(self):
        ...
        self.assertIn("updateClockDatePosition()", source)
        self.assertIn("lv_obj_get_width(clockDayLabelBold)", source)
        self.assertIn("lv_obj_set_pos(clockDateLabel, 10 + weekdayWidth + 10, 90)", source)
